    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
              ...
              <div class="card border-light mb-3 col-md-6 offset-md-3">
                ...
                <div class="card-body row mb-3">
                  <div class="col-md-4">
                    <img src="{{ asset('storage/fotokades/'.$kades_aktif->fotokades) }}" class="rounded-circle" height="120px" width="120px">
                  </div>
            ...
            <div class="d-flex justify-content-between mb-3">
              <h4 class="title text-center my-3">KEPALA DESA DAN PEJABAT PENGESAH SURAT MARGAMULYA</h4>
                ...
                <div class="card card-user">
                  <div class="card-body">
                    <div class="container text-center my-2">
                        ...
                        <img src="{{ asset('storage/fotokades/'.$k->fotokades) }}" class="rounded-circle" height="120px" width="120px">
                    </div>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            Aktifkan <b>{{ $k->nama }}</b> sebagai<br><b>Kepala Desa Margamulya</b> saat ini?
                          </div>
