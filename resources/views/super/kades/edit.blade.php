              ...
              <div class="card-body">
                <form action="{{ route('kades.foto', $kades->id) }}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="">
                    ...
                    @if ($kades->fotokades)
                      <img src="{{ asset('storage/fotokades/'.$kades->fotokades.'') }}" alt="Kades {{ $kades->nama }}" class="img-thumbnail" width="180px">
                    @endif
                  ...
                  <div class="">
                    ...
                    @if ($kades->ttdcap)
                      <img src="{{ asset('storage/ttdcap/'.$kades->ttdcap.'') }}" alt="Cap dan Ttd {{ $kades->nama }}" class="img-thumbnail" width="180px">
                    @endif
            ...
            <div class="card card-kades">
              <div class="card-body">
                <div class="container text-center my-2">
                    <img src="{{ asset('storage/fotokades/'.$kades->fotokades) }}" class="rounded-circle" width="120px">
                </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p class="text-center">Anda yakin ingin menghapus <b>{{ $kades->nama }}</b> dari <i> Data Kepala Desa Margamulya</i> ?</p>
        <small class="text-secondary text-center">*tindakan ini akan membuat {{ $kades->nama }} tidak terdata lagi di data Kepala Desa Margamulya.</small>
      </div>
