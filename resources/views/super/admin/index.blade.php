    ...
    <div class="col-md-12">
        <div class="container card">
            <div class="card-header">
                ...
                <h5 class="card-category mt-2">Daftar Admin Desa Margamulya</h5>
            </div>
            <div class="card-body">
                                  ...
                                  <div class="modal-dialog">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        ...
                                        <small class="text-secondary">*tindakan ini akan membuat {{ $adm->nama }} tidak memiliki akses untuk mengelola Website Desa Margamulya lagi.</small>
                                      </div>
    ...
    {{-- <div class="col-md-5 pl-1">
        <div class="container card">
            <div class="card-header">
                ...
                <h5 class="card-category mt-2">Daftar Super Admin Desa Margamulya</h5>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="example" class="table table-striped table-bordered">
