    ...
    <table border="0" align="center" style="margin-top: 10px;" width=84%>
        ...
        <tr>
            <td colspan="2">
                <br>
                <center>
                    <font size="3"><u><b>SURAT KETERANGAN JANDA DUDA</b></u></font><br>
        ...
        <tr>
            <td>
                ...
                <p style="text-align: center">
                    <b> == {{ $ajuan->jandaDuda->janda_duda }} dari {{ $ajuan->jandaDuda->pasangan }} yang telah {{ $ajuan->jandaDuda->kepemilikan }}, dan tidak pernah menikah lagi {{ $ajuan->pemilik }} == </b>
                </p>
                <p style="text-align: justify;">
