...
<head>
    <title>Surat Keterangan Kebakaran</title>
</head>
...
<body>
    ...
    <table border="0" align="center" style="margin-top: 10px;" width=84%>
        ...
        <tr>
            <td colspan="2">
                <br>
                <center>
                    <font size="3"><u><b>SURAT KETERANGAN KEBAKARAN</b></u></font><br>
        ...
        <tr>
            <td>
                <p style="text-align: justify;">
                    Yang bertanda tangan di bawah ini, Kepala Desa Margamulya Kecamatan Arjasari Kabupaten Bandung , menerangkan dengan sebenarnya bahwa :
                </p>
            </td>
        </tr>
    </table>
    ...
    <table border="0" align="center" width=83%>
        ...
        <tr>
            <td>
                <p style="text-align: justify;">
                    Berdasarkan keterangan dari RT dan RW setempat benar bahwa yang bersangkutan Penduduk Desa Margamulya Kecamatan Cikajang Kabupaten Garut telah melaporkan kebakaran rumah beserta barang/dokumen penting berupa :
                </p>
            </td>
        </tr>
        <tr>
            <td style="text-align: center; text-transform: uppercase; ">
                <p>
                    <b><i>{{ $ajuan->kebakaran->barang }}</i></b>
                </p>
            </td>
        </tr>
        <tr>
            <td style="text-align: justify;">
                Pada Tanggal : {{ $ajuan->kebakaran->tanggal }}
            </td>
        </tr>
        <tr>
            <td style="text-align: justify;">
