...
<body>
    ...
    <table border="0" align="center" width=83%>
        ...
        <tr>
            <td>
                <p style="text-align: justify;">
                    Orang tersebut diatas benar warga Desa Margamulya Kecamatan Cikajang  yang pada saat ini benar-benar sudah tidak bekerja sebagai {{ $puskesos->user->pekerjaan }}. surat ini digunakan untuk :
                </p>
                <p style="text-align: center;">
                    <b style="text-transform: uppercase;"> {{ $puskesos->keterangan }} <b>
                </p>
                <p style="text-align: justify;">
