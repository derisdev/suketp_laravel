...
<body>
    ...
    <table border="0" align="center" width=83%>
        ...
        <tr>
            <td>
                <p style="text-align: justify;">
                    Berdasarkan pengetahuan kami dan data yang ada benar bahwa yang bersangkutan Penduduk Desa Margamulya Kecamatan Cikajang Kabupaten Garut dan pada saat ini memiliki usaha :
                </p>
    ...
    <table border="0" align="center" width=83%>
        <tr>
            ...
            <td style="text-align: right; position:relative">
            <div style="position: relative; left: -30px;">Margamulya, {{ $sku->updated_at->format('d F Y') }} <br>
                Kepala Desa Margamulya</div>
            <img src="{{ asset('ttdcap/'.$sku->ttd).''}}" alt="" height="280" align="right" style="position:absolute; top:-30"> <br><br><br><br>
            <p style="position:absolute; right:-170 !important;top:120">{{ $sku->kades }}</p>
            </td>
            </td>
        </tr>
    </table>
