...
<body>
    ...
    <table border="0" align="center" style="margin-top: 10px;" width=84%>
        ...
        <tr>
            <td colspan="2">
                <br>
                <center>
                    <font size="3"><u><b>SURAT KETERANGAN BEDA NAMA</b></u></font><br>
    ...
    <table border="0" align="center" width=83%>
        ...
        <tr>
            <td>
                <p style="text-align: justify;">
                Berdasarkan keterangan dari RT dan RW setempat benar bahwa yang bersangkutan Penduduk Desa Margamulya Kecamatan Cikajang Kabupaten Garut dan terdapat perbedaan dalam penulisan {{ $ajuan->bedaNama->perbedaan }} di dalam {{ $ajuan->bedaNama->dokumen_benar }} tertulis {{ $ajuan->bedaNama->tertulis_benar }} sedangkan di dalam {{ $ajuan->bedaNama->dokumen_salah }} tertulis {{ $ajuan->bedaNama->tertulis_salah }}.  
                </p>
                <p style="text-align: center"><b>== Data tersebut adalah orang yang sama ==</b></p>
                <p style="text-align: justify;">
                    Surat keterangan ini digunakan untuk:
                </p>
                <p style="text-align: center">{{ $ajuan->keterangan }}</p>
