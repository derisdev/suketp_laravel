...
<head>
    <title>Surat Penghasilan - {{ $ajuan->user->nama }}</title>
</head>
...
<body>
    ...
    <table border="0" align="center" width=83%>
        ...
        <tr>
            <td>
                <p style="text-align: justify;">
                    Berdasarkan keterangan dari RT dan RW setempat benar bahwa yang bersangkutan Penduduk Desa Margamulya Kecamatan Cikajang Kabupaten BANDUNG dan :
                </p>
                <p style="text-align: center">
                    <b>
                        Benar mempunyai penghasilan rata-rata sebesar Rp. {{ $ajuan->penghasilan->besar }},-
                    </b>
                </p>
                <p style="text-align: justify;">
                    Surat keterangan ini digunakan untuk:
                </p>
                <p style="text-align: center"><i>{{ $ajuan->keterangan }}</i></p>
