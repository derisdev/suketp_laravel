...
<head>
    <title>Surat Keterangan Serbaguna - {{ $ajuan->user->nama }}</title>
</head>
...
<body>
    ...
    <table border="0" align="center" style="margin-top: 10px;" width=84%>
        ...
        <tr>
            <td colspan="2">
                <br>
                <center>
                    <font size="3"><u><b>SURAT KETERANGAN SERBAGUNA</b></u></font><br>
    ...
    <table border="0" align="center" width=83%>
        ...
        <tr>
            <td>
                <p style="text-align: justify;">
                    Berdasarkan keterangan dari RT dan RW setempat benar bahwa yang bersangkutan Penduduk Desa Margamulya Kecamatan Cikajang Kabupaten Garut.
                </p>
                <p style="text-align: justify">
                    {{ $ajuan->serbaguna->isi }}
                </p>
                <p>Demikian keterangan ini, untuk dipergunakan sebagaimana mestinya.</p>
            </td>
        </tr>
    </table>
    ...
    <table border="0" align="center" width=83%>
        <tr>
            ...
            <div style="position: relative; left: -30px;">Margamulya, {{ $ajuan->updated_at->format('d F Y') }} <br>
