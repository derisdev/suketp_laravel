...
<body>
    ...
    <table border="0" align="center" style="margin-top: 10px;" width=84%>
        ...
        <tr>
            <td colspan="2">
                <br>
                <center>
                    <font size="3"><u><b>SURAT KETERANGAN AHLI WARIS</b></u></font><br>
    ...
    <table border="0" align="center" width=83%>
        ...
        <tr>
            <td>
                <p style="text-align: justify;">
                    Berdasarkan keterangan dari RT dan RW setempat benar bahwa yang bersangkutan Penduduk Desa Margamulya Kecamatan Cikajang Kabupaten Garut dan merupakan {{ $ajuan->ahliWaris->hubungan }} dari {{ $ajuan->ahliWaris->nama_pewaris }} yang {{ $ajuan->ahliWaris->kejadian }} pada tanggal {{ $ajuan->ahliWaris->tanggal }}
                </p>
                <p style="text-align: justify;">
                    Surat keterangan ini dibuat dengan sebenar-benarnya dengan mengingat sumpah jabatan serta ke insyafan bahwa jika saya memberikan keterangan palsu/tidak benar, maka saya bersedia dituntut sesuai ketentuan hukum yang berlaku.
                </p>
            </td>
        </tr>
        <tr>
