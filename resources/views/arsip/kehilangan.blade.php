...
<body>
    ...
    <table border="0" align="center" style="margin-top: 10px;" width=84%>
        ...
        <tr>
            <td colspan="2">
                <br>
                <center>
                    <font size="3"><u><b>SURAT KETERANGAN KEHILANGAN</b></u></font><br>
    ...
    <table border="0" align="center" width=83%>
        ...
        <tr>
            <td>
                <p style="text-align: justify;">
                    Berdasarkan keterangan dari RT dan RW setempat benar bahwa yang bersangkutan Penduduk Desa Margamulya Kecamatan Cikajang Kabupaten Garut telah melaporkan kehilangan berupa :
                </p>
            </td>
        </tr>
        <tr>
            <td style="text-align: center; text-transform: uppercase; ">
                <p>
                    <b><i>{{ $ajuan->kehilangan->barang }}</i></b>
                </p>
            </td>
        </tr>
        <tr>
            <td style="text-align: justify;">
                Surat keterangan ini dibuat untuk : {{ $ajuan->keterangan }}
            </td>
        </tr>
        <tr>
            <td>
