...
<html lang="en">
  ...
  <body>
    ...
    @if (count($adatolak) != 0 || count($sktbtolak) != 0 || count($skutolak) != 0 || count($sktmtolak) != 0 || count($skcktolak) != 0 || count($puskesostolak) != 0)
    ...
    @if (count($adatolak) == 0 && count($skutolak) == 0 && count($skcktolak) == 0 && count($sktbtolak) == 0 && count($sktmtolak) == 0 && count($puskesostolak) == 0)
    <main role="main" class="container">
      <div class="my-3 p-3 bg-white rounded shadow-sm">
