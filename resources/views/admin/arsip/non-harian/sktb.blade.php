            ...
            <div class="card">
                ...
                <div class="card-header mx-4">
                    <div class="d-flex justify-content-between">
                        ...
                        <a type="button" class="btn btn-primary" href="{{ route('sktb.laporan') }}">Download Laporan</a>
                    </div>
                    <h5 class="card-category mt-2">Daftar SKTB yang telah disetujui:</h5>
                </div>
                                ...
                                <td class="text-right">
                                    <a href="" class="badge badge-warning dropdown-toggle" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Lihat</a>
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                          <a class="dropdown-item" href="{{ route('skkd.lihat', $sktm->id) }}">SKKD</a>
                                          <a class="dropdown-item" href="{{ route('sktb.lihat', $sktm->id) }}">SKTB</a>
                                        </div>
                                    <a href="{{ route('adm-sktb.download', $sktb->id) }}" class="badge badge-success">Download</a>
                                </td>
                            </tr>
                            @endforeach
                            </tbody>
