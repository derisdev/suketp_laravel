                                        ...
                                        <div class="modal-body">
                                          <form action="{{ route('pesan-penolakan.update', $p->id) }}" method="post">
                                            ...
                                            <div class="form-group">
                                              ...
                                              <textarea class="form-control" name="isi" id="isi" cols="30" rows="10" placeholder="cont: Mohon maaf, pengajuan anda tertolak dikarenakan anda tidak berdomisili di Desa Sindangsuka">{{ $p->isi }}</textarea>
                                            </div>
                                          </div>
